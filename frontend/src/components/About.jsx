      ...
      <div className="max-w-7xl mx-auto px-6">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-16 items-center">
                ...
                <>
                  ...
                  <div className="flex justify-between items-start z-10 p-8 w-full">
                    <div className="p-3 bg-white/10 backdrop-blur-md border border-white/20 rounded-2xl">
                      <FaLaptopCode className="text-[#C6A75E]xl text-white" />
                    </div>
                  ...
                  <div className="z-10 p-8 text-left mt-auto">
                    <h4 className="font-poppins font-bold text-[#C6A75E]xl text-white mb-1">{personalInfo.name || "Nitesh Kumar"}</h4>
                ...
                <div className="flex flex-col justify-between h-full w-full p-8 relative">
                  ...
                  <div className="flex justify-between items-start z-10">
                    <div className="p-3 bg-white shadow-sm border border-slate-100 rounded-2xl">
                      <FaLaptopCode className="text-[#C6A75E]xl text-[#C6A75E]" />
                    </div>
                  ...
                  <div className="my-8 flex flex-col items-center justify-center z-10">
                    <div className="w-28 h-28 rounded-full bg-gradient-to-tr from-[#C6A75E] to-[#1F2A44] p-1 flex items-center justify-center shadow-lg shadow-blue-500/15 mb-4 relative">
                      <span className="w-full h-full bg-[#1F2A44] rounded-full flex items-center justify-center text-white text-[#C6A75E]xl font-poppins font-black">
                        NK
                      </span>
                  ...
                  <div className="bg-[#1F2A44] text-white rounded-2xl p-4 border border-slate-800 text-left z-10 shadow-lg">
          ...
          <div className="lg:col-span-7 text-left">
            ...
            >
              <h4 className="font-poppins font-bold text-sm text-[#1F2A44] mb-4">Core Commitments:</h4>
            ...
            >
              <a
                ...
                className="inline-flex items-center gap-2 font-inter text-sm font-bold text-white bg-[#C6A75E] hover:bg-[#B0934E] active:scale-98 px-6 py-3.5 rounded-xl shadow-md transition-all duration-200"
              >
