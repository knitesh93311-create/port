          ...
          <div className="lg:col-span-5 flex flex-col gap-6 justify-between">
            ...
            <div className="flex flex-col gap-6 text-left">
              ...
              <div className="bg-white border border-blue-900/30 p-6 rounded-2xl flex items-start gap-4 shadow-sm hover:shadow-md transition-all">
                <span className="p-3 bg-[#FF9100]/10 text-[#FF9100] border border-[#FF9100]/20 rounded-xl">
                  <FaMapMarkerAlt size={18} />
                </span>
                <div>
                  <h4 className="font-poppins font-bold text-[#0B2C1F] text-sm">Location</h4>
              ...
              >
                <span className="p-3 bg-cyan-50 text-[#0B2C1F] border border-cyan-100 rounded-xl">
                  <FaEnvelope size={18} />
                </span>
                <div>
                  <h4 className="font-poppins font-bold text-[#0B2C1F] text-sm">Email Address</h4>
              ...
              >
                ...
                <div>
                  <h4 className="font-poppins font-bold text-[#0B2C1F] text-sm">LinkedIn Profile</h4>
              ...
              >
                ...
                <div>
                  <h4 className="font-poppins font-bold text-[#0B2C1F] text-sm">GitHub Profile</h4>
            ...
            <div className="bg-[#0B2C1F] text-white p-6 rounded-2xl border border-blue-800/40 text-left shadow-lg hidden lg:block">
              ...
              <AnimatePresence mode="wait">
                {submitStatus !== 'success' ? (
                  ...
                  >
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-5">
                      ...
                      <div className="flex flex-col items-start">
                        <label htmlFor="name" className="font-poppins text-xs font-bold text-[#0B2C1F] mb-1.5">
                          Your Name
                        </label>
                        <input
                          type="text"
                          ...
                          className={`w-full font-inter text-sm px-4 py-3 rounded-xl border outline-none bg-slate-50 transition-all ${
                            touched.name && errors.name 
                              ...
                              : 'border-slate-200 focus:border-[#FF9100] focus:bg-white'
                          }`}
                      ...
                      {/* Email input */}
                      <div className="flex flex-col items-start">
                        <label htmlFor="email" className="font-poppins text-xs font-bold text-[#0B2C1F] mb-1.5">
                          Email Address
                        </label>
                        <input
                          type="email"
                    ...
                    {/* Subject Input */}
                    <div className="flex flex-col items-start">
                      <label htmlFor="subject" className="font-poppins text-xs font-bold text-[#0B2C1F] mb-1.5">
                        Subject
                      </label>
                      <input
                        type="text"
                    ...
                    <div className="flex flex-col items-start flex-grow">
                      <label htmlFor="message" className="font-poppins text-xs font-bold text-[#0B2C1F] mb-1.5">
                        Message
                      </label>
                      <textarea
                        id="message"
                    ...
                    <button
                      type="submit"
                      disabled={isSubmitting}
                      className="w-full inline-flex items-center justify-center gap-2 font-inter text-sm font-bold text-white bg-[#FF9100] hover:bg-[#E08000] disabled:bg-blue-400 py-4 rounded-xl shadow-md transition-all active:scale-98 cursor-pointer"
                    >
                      {isSubmitting ? (
                        <>
                  ...
                  >
                    ...
                    <h3 className="font-poppins font-extrabold text-[#FF9100]xl text-[#0B2C1F] mb-3">
