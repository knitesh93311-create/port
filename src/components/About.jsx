...
export default function About() {
  return (
    <section id="about" className="py-24 bg-white relative overflow-hidden">
      ...
      <div className="absolute top-[10%] left-[-5%] w-[300px] h-[300px] rounded-full bg-blue-50/50 blur-[80px] pointer-events-none" />
      ...
      <div className="max-w-7xl mx-auto px-6">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-16 items-center">
          ...
          >
            {/* Visual Frame Decor */}
            <div className="absolute -inset-4 rounded-3xl bg-gradient-to-tr from-blue-500/10 to-cyan-500/10 blur-xl opacity-80 pointer-events-none" />
            
            {/* Main Interactive Portrait Art */}
            <div className="relative bg-gradient-to-b from-slate-50 to-slate-100 rounded-3xl border border-slate-200/80 p-8 shadow-md aspect-[4/5] flex flex-col justify-between overflow-hidden group">
              
              {/* Abstract overlay */}
              <div className="absolute -right-20 -top-20 w-60 h-60 rounded-full bg-cyan-100/30 group-hover:scale-110 transition-transform duration-700" />
              ...
              <div className="my-8 flex flex-col items-center justify-center z-10">
                <div className="w-28 h-28 rounded-full bg-gradient-to-tr from-blue-600 to-cyan-400 p-1 flex items-center justify-center shadow-lg shadow-blue-500/15 mb-4 relative">
                  <span className="w-full h-full bg-[#0F172A] rounded-full flex items-center justify-center text-white text-3xl font-poppins font-black">
                    NK
                  </span>
              ...
              <div className="bg-[#0F172A] text-white rounded-2xl p-4 border border-slate-800 text-left z-10 shadow-lg">
                ...
                <div className="grid grid-cols-3 gap-2 text-center font-mono text-[10px]">
                  <div className="bg-slate-800/50 p-2 rounded-lg border border-slate-700/30">
                    ...
                    <p className="text-[#38BDF8] font-bold">95%</p>
                  </div>
                  <div className="bg-slate-800/50 p-2 rounded-lg border border-slate-700/30">
          ...
          <div className="lg:col-span-7 text-left">
            ...
            >
              ...
              <h2 className="font-poppins font-extrabold text-3xl sm:text-4xl text-[#0F172A] leading-tight mb-6">
            ...
            >
              <div className="flex gap-3 items-start">
                <span className="p-2 bg-blue-50 rounded-lg text-[#2563EB] mt-0.5"><FaLaptopCode size={16} /></span>
                <div>
                  <h4 className="font-poppins font-bold text-sm text-[#0F172A]">Full Stack Systems</h4>
                  <p className="font-inter text-xs text-slate-500 leading-normal">Front-to-back architecture planning.</p>
                </div>
              </div>
              <div className="flex gap-3 items-start">
                <span className="p-2 bg-cyan-50 rounded-lg text-[#06B6D4] mt-0.5"><FaDatabase size={16} /></span>
                <div>
                  <h4 className="font-poppins font-bold text-sm text-[#0F172A]">Database Integrity</h4>
              ...
              <div className="flex gap-3 items-start">
                ...
                <div>
                  <h4 className="font-poppins font-bold text-sm text-[#0F172A]">Secure Authorization</h4>
              ...
              <div className="flex gap-3 items-start">
                ...
                <div>
                  <h4 className="font-poppins font-bold text-sm text-[#0F172A]">Deployment Pipelines</h4>
            ...
            >
              <h4 className="font-poppins font-bold text-sm text-[#0F172A] mb-4">Core Commitments:</h4>
            ...
            >
              <a
                ...
                className="inline-flex items-center gap-2 font-inter text-sm font-bold text-white bg-[#2563EB] hover:bg-[#1D4ED8] active:scale-98 px-6 py-3.5 rounded-xl shadow-md transition-all duration-200"
              >
